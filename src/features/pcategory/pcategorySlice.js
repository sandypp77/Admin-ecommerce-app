...
import ProductCategory from "./pcategoryService";

export const getProductCategories = createAsyncThunk(
  "productCategory/get-categories",
  async (thunkAPI) => {
    try {
      return await ProductCategory.getProductCategories();
    } catch (error) {
...
export const createCategory = createAsyncThunk(
  ...
  async (categoryData, thunkAPI) => {
    try {
      return await ProductCategory.createProductCategory(categoryData);
    } catch (error) {
      return thunkAPI.rejectWithValue(error);
    }
  }
...
export const updateAProductCategory = createAsyncThunk(
  ...
  async (category, thunkAPI) => {
    try {
      return await ProductCategory.updateProductCategory(category);
    } catch (error) {
      return thunkAPI.rejectWithValue(error);
    }
  }
...
export const deleteAProductCategory = createAsyncThunk(
  ...
  async (id, thunkAPI) => {
    try {
      return await ProductCategory.deleteProductCategory(id);
    } catch (error) {
      return thunkAPI.rejectWithValue(error);
    }
  }
...
export const getAProductCategory = createAsyncThunk(
  ...
  async (id, thunkAPI) => {
    try {
      return await ProductCategory.getProductCategory(id);
    } catch (error) {
      return thunkAPI.rejectWithValue(error);
    }
  }
